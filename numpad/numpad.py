...
# Setup GPIO
my_logger.debug('Setting up GPIO...')
...
def keypadCallback(channel):
    my_logger.debug('Keypad callback triggered!')
...
def setAllLines(state):
    my_logger.debug('Setting all lines to ' + str(state))
...
def checkSpecialKeys():
    my_logger.debug('Checking special keys...')
    global input
    pressed = False
 ...
 #       pressed = True
    ...
    if (not pressed):
        if input == secretCode:
            ...
            my_logger.debug('Code correct!')
        else:
            print("Incorrect code!")
            # TODO: Sound an alarm, send an email, etc.
            my_logger.debug('Incorrect code!')
        pressed = True
...
def readLine(line, characters):
    my_logger.debug('Reading line ' + str(line))
    global input
...
try:
    ...
    print("\nApplication stopped!")
    my_logger.debug('Application stopped!')